        ...
        <div class="relative">
            ...
            <div class="mt-6 md:mt-8 lg:mt-12 xl:mt-16">
                ...
                <div class="flex items-center justify-center gap-3 mt-5 md:mt-8 lg:mt-10 xl:mt-14">
                    <button type="button" @click="slidePrevCarousel" name="slide-prev" aria-label="slide prev"
                    ...
                    <button type="button" @click="slideNextCarousel" name="slide-next" aria-label="slide next"
